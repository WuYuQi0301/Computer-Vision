#include "copy.hpp"
canny::canny(string filename, string root, int num, int filter_size,int sigmaIn, int low , int high, int note)
{
	...
	else
	{
	    ...
	    thres.save((root + to_string(num) + "Thresholded.bmp").c_str());
